...
This page describes OCaml version **4.02.0**,
released in July 2014. Go [here](./) for a list of all releases.

## What's New

Some of the highlights of this release 4.02 are:
...
The
[INSTALL](http://caml.inria.fr/pub/distrib/ocaml-4.02/notes/INSTALL)
...
Binary package compiled on Mac OS 10.XX with XCode tools XX (probably
